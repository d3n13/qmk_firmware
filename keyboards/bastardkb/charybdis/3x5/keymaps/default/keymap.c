...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [LAYER_GAMING_NUMS] = LAYOUT_wrapper(
   ...
   [LAYER_SETUP] = LAYOUT_wrapper(
      ...
      _______, _______, _______, DPI_MOD,                    S_D_MOD,                    _______, _______, _______, _______, KC_BRIU,
      _______, _______, _______, TG(LAYER_WINDOWS_GUI_CTRL), _______,                    _______, _______, _______, _______, KC_BRID,
                                 _______,                    _______, _______,  _______, _______
   ),
};
